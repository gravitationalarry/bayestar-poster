...
\lettrine{\fontspec{Copse}P}{lanning} telescope pointings for followup of gravitational wave (GW) events is a challenging optimization problem.  Probability maps conditioned on GW observations (GW sky maps) are multimodal and dispersed over 4π.
...
\lettrine{\fontspec{Copse}S}{ky maps} are posterior distributions of source location $\omega$ given all GW observations \GW.  The GW sky map is
%
$$
...
\lettrine{\fontspec{Copse}F}{or multiple telescopes}, the figure of merit is the probability of imaging the source with at least one telescope:
$$
