...
poster.pdf: poster.tex title-drawing.pdf spatial.pdf multipole.pdf ../efficiency_distance.pdf ../efficiency_histogram.pdf ../proposal.bib ../telescope.bib ../telescope_list.bib smile.pdf ligo.pdf ligosmile.pdf example-no-interference.pdf
